...
3.4 Analisis dan Perancangan Sistem	22
3.4.1 Analisis Kebutuhan Fungsional dan Non-Fungsional	22
3.4.2 Use Case Diagram	24
3.4.3 Activity Diagram Proses Kritis	27
3.4.4 Sequence Diagram	31
3.4.5 Class Diagram	33
3.4.6 Perancangan Skema Basis Data Relasional 3NF dan ERD	34
3.4.7 Arsitektur Sistem 3-Tier MVC	37
3.5 Implementasi Sistem	38
3.6 Pengujian Sistem	41
3.7 Jadwal Penelitian	42
BAB IV HASIL DAN PEMBAHASAN	44
4.1 Implementasi Kode Program Backend dan Logika Bisnis	44
4.1.1 Arsitektur 3-Tier MVC dan Service Layer Decoupling	44
4.1.2 Cronjob Pembangkitan Invoice Bulanan dan Idempotency Guard Late Fee	46
4.1.3 Penanganan Webhook Callback Payment Gateway Midtrans Snap API	49
4.1.4 Otentikasi Google OAuth API via Laravel Socialite dan Complete Profile	52
4.1.5 Subsistem Notifikasi Asinkron Fonnte WhatsApp API dan SMTP TLS Mailer	55
4.1.6 Penanganan Konflik Unique Constraint Soft Deletes Berbasis Virtual Generated Columns	57
4.2 Hasil Implementasi Antarmuka Lingkungan Lokal (Localhost)	58
4.2.1 Pengecekan Server Lokal dan Kompilasi Bundel Aset	58
4.2.2 Halaman Publik Portal Informasi dan Detail Unit Kamar	59
4.2.3 Panel Kontrol Dasbor Administrasi Utama Kost	60
4.2.4 Portal Mandiri Transaksional dan Unduh Dokumen Penyewa Kost	61
4.2.5 Workspace Alur Pemesanan (5-Step Stepper & Middleware)	62
4.3 Konfigurasi Penyiapan Perangkat Peladen Produksi (Shared Hosting Production)	63
4.3.1 Integrasi Server Produksi (Hostinger LiteSpeed Enterprise)	63
4.3.2 Analisis Komparasi Parameter Lingkungan Perangkat Peladen	64
4.4 Pengujian Sistem (Testing, Validasi, dan Quality Assurance)	66
4.4.1 Hasil Eksekusi Automated Testing Suite Framework PHPUnit	66
4.4.2 Hasil Pengujian Validasi Fungsionalitas Kotak Hitam (Black-Box Testing)	67
4.5 Sesi Wawancara Evaluasi Pengguna (Pemilik Kost)	70
4.5.1 Hasil Tanya Jawab (Q&A) Evaluasi Operasional Aplikasi Bersama Bapak Asep	70
4.5.2 Implikasi Penggunaan Sistem Terhadap Efisiensi Operasional Kost	71
DAFTAR PUSTAKA	73

DAFTAR TABEL
Tabel 2.1  Perbandingan Penelitian Terdahulu (State of the Art)	16
Tabel 3.1  Kebutuhan Non-Fungsional Sistem	23
Tabel 3.2  Struktur Tabel Utama Basis Data Sistem	34
Tabel 3.3  Jadwal Penelitian	42
Tabel 4.1  Perbandingan Parameter Konfigurasi Lingkungan Server	64
Tabel 4.2  Matriks Hasil Pengujian Kotak Hitam (Black-Box Testing)	67
Tabel 4.3  Rangkuman Hasil Wawancara Evaluasi Operasional	70

DAFTAR GAMBAR
Gambar 2.1  Kerangka Pemikiran Penelitian	18
Gambar 3.1  Use Case Diagram Sistem Asri Boarding House	25
Gambar 3.2  Activity Diagram Tiga Proses Kritis Sistem	27
Gambar 3.3  Sequence Diagram Alur Utama Sistem	32
Gambar 3.4  Class Diagram Model, Service, dan Observer Sistem	33
Gambar 3.5  Entity Relationship Diagram (ERD) Skema Basis Data Lengkap 22 Tabel	35
Gambar 4.1  Mekanisme Billing Engine Massal	46
Gambar 4.2  Middleware Validasi Webhook Signature	49
Gambar 4.3  Alur Interseptor Profil Google OAuth	52
Gambar 4.4  Sistem Notifikasi Fonnte WA Service	55
Gambar 4.5  Kompilasi Bundel Aset Vite Produksi	58
Gambar 4.6  Antarmuka Katalog Kamar Publik Neo-Brutalisme	59
Gambar 4.7  Dasbor Administrasi Keuangan Administrator	60
Gambar 4.8  Portal Invoice and Kuitansi PDF Penyewa	61
Gambar 4.9  Workspace Stepper Alur Reservasi Calon Penyewa	62
Gambar 4.10  Output Terminal php artisan test Passed	66
Gambar 4.11  Dokumentasi UAT Sesi Wawancara dan Penyerahan Sistem	71
...
•	Batas linimasa riset. Penelitian berhenti pada fase pengujian dan penyerahan laporan; fase pemeliharaan (maintenance) jangka panjang berada di luar linimasa enam bulan sebagaimana ditegaskan pada Sub-bab 3.2.
...
Penyusunan skripsi ini dibagi ke dalam tiga bab yang saling berkaitan secara sistematis, dengan uraian sebagai berikut.
...
BAB II TINJAUAN PUSTAKA DAN LANDASAN TEORI membahas teori-teori pendukung yang relevan, meliputi sistem informasi manajemen, e-commerce B2C, sistem manajemen basis data relasional dan normalisasi, arsitektur 3-tier dan MVC pada Laravel 11, mekanisme Application Programming Interface (API) eksternal, automated billing engine dan penjadwalan tugas (task scheduling), teori interaktivitas UI/UX Neo-Brutalism dan WCAG 2.1, serta konsep keamanan web. Bab ini turut menyajikan penelitian terdahulu (state of the art) dalam bentuk tabel komparatif beserta kerangka pemikiran penelitian.
BAB III METODOLOGI PENELITIAN menguraikan jenis penelitian, metode pengembangan sistem beserta justifikasinya, teknik pengumpulan data, analisis dan perancangan sistem (kebutuhan fungsional dan non-fungsional, use case diagram, activity diagram, sequence diagram, class diagram, perancangan basis data beserta ERD, dan arsitektur sistem), implementasi sistem, metodologi pengujian, serta jadwal penelitian. 
BAB II 
...
1)	Analisis Kebutuhan (Requirements Analysis): mengidentifikasi kebutuhan fungsional dan non-fungsional melalui observasi lapangan, wawancara, serta studi dokumen blueprint.
...
Pengumpulan data dilakukan melalui tiga teknik yang saling melengkapi guna memastikan kebutuhan sistem terbangun dari kondisi faktual di lapangan. Ketiga teknik tersebut dirancang agar data yang diperoleh dapat ditriangulasi sehingga validitasnya terjaga.
...
3.4.1 Analisis Kebutuhan Fungsional dan Non-Fungsional
...
Kebutuhan non-fungsional menetapkan atribut kualitas dan batasan operasional yang harus dipenuhi sistem, sebagaimana dirangkum pada Tabel 3.1.

Tabel 3.1 Kebutuhan Non-Fungsional Sistem
...
Interaksi keempat aktor disajikan dalam tiga sudut pandang modul pada Gambar 3.1.
...
Gambar 3.1 Use Case Diagram Sistem Asri Boarding House
Sumber: Rancangan penulis berdasarkan dokumen blueprint (2026)
3.4.3 Activity Diagram Proses Kritis
Activity diagram dirancang untuk memodelkan tiga proses kritis yang menjadi inti kebaruan sistem. Ketiganya disajikan pada Gambar 3.2.
...
Tabel 3.2 Struktur Tabel Basis Data Sistem
...
Gambar 3.5 Entity Relationship Diagram (ERD) Skema Basis Data Lengkap 22 Tabel
...
3.4.7 Arsitektur Sistem 3-Tier MVC
...
Implementasi mewujudkan hasil perancangan ke dalam basis kode Laravel 11 dengan penataan direktori berorientasi domain agar setiap berkas mudah ditelusuri. Controller dikelompokkan menurut portal, logika bisnis dipusatkan pada app/Services, sedangkan efek samping model ditempatkan pada app/Observers. Struktur pokok proyek diilustrasikan berikut:
...
│       ├── ClearOldNotificationLogs.php
│       ├── GenerateBulananTagihan.php
│       ├── ProsesKeterlambatanCommand.php
│       ├── ProsesKeterlambatanTagihan.php
│       ├── PruneClosedGuestChats.php
│       └── TruncateLogFile.php
├── Http/
│   ├── Controllers/
│   │   ├── Admin/
...
│   │   │   ├── GuestChatController.php
│   │   │   ├── KamarController.php
│   │   │   ├── KeluhanController.php
│   │   │   ├── LaporanController.php
│   │   │   ├── NotifikasiController.php
│   │   │   ├── NotifikasiKhususController.php
...
│   │   └── Api/
│   │       ├── ChatController.php
│   │       ├── GuestChatApiController.php
│   │       ├── MidtransCallbackController.php
│   │       ├── MidtransReservasiCallbackController.php
│   │       └── SnapTokenController.php
│   └── Middleware/
...
│   ├── Fasilitas.php
│   ├── Gallery.php
│   ├── GuestChatMessage.php
│   ├── GuestChatThread.php
│   ├── Kamar.php
│   ├── Keluhan.php
│   ├── LogNotifikasi.php
│   ├── NotifikasiKhusus.php
│   ├── Pembayaran.php
│   ├── Pengeluaran.php
│   ├── Pengumuman.php
│   ├── Penyewa.php
...
└── Services/
    ...
    ├── PdfNotaService.php
    ├── ReservasiService.php
    └── TransisiPenyewaService.php
database/
├── migrations/
└── seeders/
resources/
...
Arsitektur perutean (routing) memisahkan rute ke dalam kelompok berprefiks sesuai portal — /admin, /penyewa, /reservasi, rute publik, dan /api — yang masing-masing dilekati middleware dan named route tersendiri. Titik akhir webhook Midtrans diletakkan pada routes/api.php dan dikecualikan dari proteksi CSRF karena dipanggil oleh peladen eksternal, sedangkan seluruh formulir internal tetap memikul token CSRF.
Tumpukan middleware (middleware stack) menegakkan keamanan berlapis. Tiga guard autentikasi terpisah melayani administrator, penyewa aktif, dan calon penyewa; middleware berbasis peran menerapkan Role-Based Access Control, sementara middleware PenyewaAuth memverifikasi kepemilikan data (tagihan->penyewa_id == auth()->user()->penyewa->id) untuk menutup celah IDOR dengan mengembalikan HTTP 403 bila tidak cocok. Pembatasan laju diberlakukan pada rute autentikasi, dan middleware ForcePasswordChange memaksa penggantian kata sandi bawaan saat administrator login pertama kali.
Masukan finansial diamankan melalui teknik dual-field delimiter input berbasis JavaScript. Bidang yang terlihat menampilkan nominal dengan pemisah ribuan bertanda titik agar mudah dibaca, sedangkan bidang tersembunyi (hidden input) mengirimkan bilangan bulat murni (raw integer) ke MySQL. Pemisahan ini menekan kesalahan masukan (input error) sekaligus menjaga konsistensi tipe data di basis data. Adapun kanal chat menerapkan AJAX polling: peramban menarik pesan baru pada interval 3–5 detik dan merender gelembung percakapan asimetris, aktif selama reservasi berstatus pending untuk verifikasi kesiapan kamar pra-pembayaran.
Inisialisasi proyek dilakukan melalui berkas konfigurasi .env yang memuat APP_KEY, kredensial basis data (DB_*), kunci Midtrans (MIDTRANS_SERVER_KEY, MIDTRANS_CLIENT_KEY), token FONNTE_TOKEN, konfigurasi surel (MAIL_*), serta pengaturan QUEUE_CONNECTION dan CACHE_STORE. Penjadwalan otomatis diaktifkan dengan mendaftarkan satu entri cron pada peladen, yakni * * * * * php artisan schedule:run, yang menjadi pemicu tunggal bagi seluruh tugas terjadwal mesin penagihan.
3.6 Pengujian Sistem
Penjaminan mutu kode dilakukan melalui kombinasi black box testing, validasi formulir, dan pengujian otomatis (automated testing) berbasis PHPUnit. Pendekatan black box menilai kesesuaian masukan dan keluaran tanpa menelaah struktur internal kode, sehingga cocok untuk memverifikasi fungsionalitas dari perspektif pengguna [19], [20]. Pengujian otomatis melengkapinya dengan mengunci perilaku logika bisnis agar setiap perubahan kode tidak diam-diam merusak fungsi yang telah berjalan.
Pengujian unit (unit testing) difokuskan pada logika BillingService. Metode generateTagihanBulanan() diuji untuk memastikan tagihan terbit dengan nominal pokok yang tepat dari penyewa.harga_sewa, jatuh tempo pada tanggal 10, dan tidak berganda berkat constraint unik gabungan. Metode prosesKeterlambatan() diuji untuk memvalidasi model denda flat kalender: selama bulan periode berjalan tagihan bebas denda dan hanya memicu reminder WhatsApp berkala, disertai eskalasi notifikasi ke wali pada bulan kedua sebagai langkah persuasif; begitu tagihan yang masih pending memasuki bulan kalender berikutnya, denda flat 5% dari nominal pokok dikenakan tepat satu kali melalui Idempotency Guard tanpa akumulasi maupun batas atas, dan pemrosesan pada hari-hari berikutnya dipastikan idempoten sehingga tidak menghasilkan denda ganda. Asersi numerik memastikan perhitungan denda akurat hingga ke nilai rupiah.
Pengujian fitur (feature testing) menelusuri alur pembayaran secara menyeluruh. Skenario callback Midtrans diuji dengan tanda tangan valid maupun manipulatif untuk memverifikasi bahwa hanya transaksi sah yang mengubah status tagihan menjadi lunas, sekaligus memastikan sifat idempotent sehingga callback berulang tidak terproses ganda. Jalur konfirmasi tunai diuji untuk membuktikan bahwa pembaruan status dan pencatatan pembayaran berlangsung atomik dalam satu DB::transaction, diikuti pembangkitan nota PDF dan pencatatan log notifikasi.
Aspek krusial lain adalah asersi atas Safety Deletion Constraints. Pengujian membuktikan bahwa unit kamar yang masih terikat penyewa atau reservasi aktif tidak dapat dihapus, dan profil penyewa yang memiliki riwayat tagihan ditolak penghapusannya demi menjaga integritas pembukuan. Setiap upaya penghapusan terlarang diharapkan menghasilkan penolakan yang aman beserta pesan kesalahan, bukan kegagalan basis data yang tidak terkendali.
Seluruh rangkaian pengujian ditargetkan lulus penuh, dengan capaian feature test suite sebanyak 510 pengujian lulus (passed tests) dan 2.211 asersi (assertions) pada tingkat kelulusan 100%. Capaian ini menjadi jaring pengaman terhadap regression bug dan menjadi bukti empiris kelayakan fungsional sistem sebelum diserahkan.
3.7 Jadwal Penelitian
Penelitian dilaksanakan selama enam bulan, terhitung sejak bulan pertama hingga bulan keenam tahun 2026, dengan tahapan sebagaimana disajikan pada Tabel 3.3.
Tabel 3.3 Jadwal Penelitian
Kegiatan	B-1	B-2	B-3	B-4	B-5	B-6
Analisis kebutuhan & pengumpulan data	■					
Studi pustaka & penyusunan Skripsi	■	■				
Perancangan UML & basis data 3NF		■	■			
Implementasi coding sistem			■	■	■	
Pengujian sistem (testing)					■	■
Penyusunan laporan & sidang						■
Keterangan: B = Bulan; ■ = periode pelaksanaan kegiatan. Sumber: Rancangan penulis (2026) 

# BAB IV HASIL DAN PEMBAHASAN

## 4.1 Implementasi Kode Program Backend dan Logika Bisnis
...
### 4.1.1 Arsitektur 3-Tier MVC dan Service Layer Decoupling
...
### 4.1.3 Penanganan Webhook Callback Payment Gateway Midtrans Snap API
...
### 4.1.4 Otentikasi Google OAuth API via Laravel Socialite dan Complete Profile
...
### 4.1.5 Subsistem Notifikasi Asinkron Fonnte WhatsApp API dan SMTP TLS Mailer
...
## 4.2 Hasil Implementasi Antarmuka Lingkungan Lokal (Localhost)
...
### 4.2.1 Pengecekan Server Lokal dan Kompilasi Bundel Aset
...
Kompilasi tersebut turut melahirkan berkas manifes produksi di `public/build/manifest.json` yang akan dibaca secara dinamis oleh peladen Laravel via direktif `@vite` guna menjamin keakuratan resolusi nama berkas terenkripsi saat *runtime*. Untuk memfasilitasi akses peramban terhadap berkas statis dinamis (seperti gambar kamar kost dan dokumen PDF nota tagihan yang dibangkitkan sistem), dijalankan tautan simbolis melalui perintah `php artisan storage:link` yang memetakan folder penyimpanan privat `storage/app/public/` ke direktori publik `public/storage/`. Keluaran manifest dari proses kompilasi bundel aset Vite produksi ditunjukkan pada Gambar 4.5:

![Gambar 4.5 Kompilasi Bundel Aset Vite Produksi](file:///c:/xampp/htdocs/asri-boarding-house/Skripsi/images/gambar_4_6.webp)
*Gambar 4.5 Kompilasi Bundel Aset Vite Produksi*

### 4.2.2 Halaman Publik Portal Informasi dan Detail Unit Kamar
...
Dasbor ini turut diperkuat oleh tiga kartu ringkasan keuangan (*Summary Cards*) utama, meliputi Total Pemasukan, Total Pengeluaran, dan Laba Bersih, yang dikalkulasi langsung melalui kueri agregat basis data. Mekanisme otomasi kalkulasi akuntansi mikro (*micro-accounting*) ini menggantikan pencatatan buku konvensional guna mengeliminasi potensi kesalahan penghitungan manual (*human calculation error*) dan mengamankan pelacakan kapasitas pendapatan bruto maksimum kos sebesar Rp28.500.000 per bulan secara real-time. Rendering dasbor administrasi keuangan disajikan pada Gambar 4.7:

![Gambar 4.7 Dasbor Administrasi Keuangan Administrator](file:///c:/xampp/htdocs/asri-boarding-house/Skripsi/images/gambar_4_8.webp)
*Gambar 4.7 Dasbor Administrasi Keuangan Administrator*

### 4.2.4 Portal Mandiri Transaksional dan Unduh Dokumen Penyewa Kost
...
### 4.3.2 Analisis Komparasi Parameter Lingkungan Perangkat Peladen
...
*Tabel 4.1 Perbandingan Parameter Konfigurasi Lingkungan Server*

---

## 4.4 Pengujian Sistem (Testing, Validasi, dan Quality Assurance)
...
### 4.4.1 Hasil Eksekusi Automated Testing Suite Framework PHPUnit
...
Visualisasi keluaran pengujian otomatis terminal disajikan pada Gambar 4.10:

![Gambar 4.10 Output Terminal php artisan test Passed](file:///c:/xampp/htdocs/asri-boarding-house/Skripsi/images/gambar_4_11.webp)
*Gambar 4.10 Output Terminal php artisan test Passed*

### 4.4.2 Hasil Pengujian Validasi Fungsionalitas Kotak Hitam (Black-Box Testing)
Pengujian kotak hitam berfokus pada pengujian fungsionalitas masukan dan keluaran sistem tanpa melibatkan struktur kode program secara langsung. Matriks pengujian fungsionalitas kotak hitam disajikan secara detail pada tabel di bawah ini:
...
### 4.5.1 Hasil Tanya Jawab (Q&A) Evaluasi Operasional Aplikasi Bersama Bapak Asep
...
*Tabel 4.3 Rangkuman Hasil Wawancara Evaluasi Operasional*

### 4.5.2 Implikasi Penggunaan Sistem Terhadap Efisiensi Operasional Kost
...
Di sisi lain, transparansi akuntansi mikro (*micro-accounting*) terlindungi secara atomik melalui pencatatan mutasi kas yang terkomputerisasi. Setiap transaksi — baik pembayaran uang muka reservasi daring via Midtrans maupun pembayaran tunai yang dikonfirmasi admin — terekam dengan jejak audit yang jelas (*audit trail*). Sistem notifikasi WhatsApp asinkron yang terhubung ke wali penyewa turut menekan angka penunggakan sewa hingga titik minimal. Keseluruhan proses ini menyimpulkan bahwa digitalisasi administrasi kost berhasil memodernisasi tata kelola operasional Asri Boarding House secara terukur dan aman. Dokumentasi pelaksanaan evaluasi pengguna disajikan pada Gambar 4.11:

![Gambar 4.11 Dokumentasi UAT Sesi Wawancara dan Penyerahan Sistem](file:///c:/xampp/htdocs/asri-boarding-house/Skripsi/images/gambar_4_12.webp)
*Gambar 4.11 Dokumentasi UAT Sesi Wawancara dan Penyerahan Sistem*
