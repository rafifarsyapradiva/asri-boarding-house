        ...
        <div class="col-span-12 lg:col-span-5 hidden lg:flex flex-col justify-between p-10 bg-black text-white relative overflow-hidden border-r-4 border-black dark:border-white">
            ...
            <div class="my-auto space-y-6 relative z-10">
                <h1 class="text-3xl sm:text-4xl font-black leading-none tracking-tight text-white uppercase font-sans">
                    Kelola Reservasi & <br>
                    <span class="bg-yellow-400 text-black px-2 py-1 inline-block -rotate-1 border-2 border-black mt-2">Tagihan Kost.</span>
                </h1>
                <p class="text-xs text-gray-300 leading-relaxed font-bold">
                    Masuk ke portal manajemen untuk mengelola reservasi kamar, mengecek tagihan bulanan, melakukan pembayaran online, dan berinteraksi langsung dengan admin.
                </p>
                ...
                <div class="space-y-4 pt-2">
                    ...
                    <div class="flex items-center gap-3.5">
                        <span class="text-lg">💳</span>
                        <span class="text-xs font-black uppercase tracking-wider text-yellow-400">Pembayaran Praktis via Midtrans</span>
                    </div>
                    <div class="flex items-center gap-3.5">
                        <span class="text-lg">💬</span>
                        <span class="text-xs font-black uppercase tracking-wider text-yellow-400">Chat Langsung dengan Pengelola</span>
                    </div>
                </div>
            </div>
        ...
        <div class="col-span-12 lg:col-span-7 p-8 sm:p-12 flex flex-col justify-center bg-white dark:bg-slate-900">
            <div class="w-full max-w-md mx-auto">
                ...
                <div class="mb-8 text-center lg:text-left">
                    <h2 class="text-3xl font-black text-black dark:text-white uppercase tracking-tight">Selamat Datang Kembali</h2>
                    <p class="text-xs text-gray-600 dark:text-gray-400 mt-1.5 font-bold uppercase tracking-wide">Masuk untuk mengelola reservasi dan tagihan Anda.</p>
                </div>
                ...
                <div class="mb-6">
                    <x-auth.google-button :route="route('auth.google')" text="Masuk dengan Google" />
                </div>
                ...
                <!-- Manual Login Form -->
                <form method="POST" action="{{ route('login') }}" class="space-y-5" id="loginForm" data-testid="form-login">
                    @csrf
                    ...
                    <div>
                        <div class="flex justify-between items-center mb-2">
                            ...
                            @if (Route::has('password.request'))
                                <a class="text-[10px] font-black uppercase tracking-wider text-black dark:text-yellow-400 hover:underline" href="{{ route('password.request') }}">
                                    Lupa sandi?
                                </a>
                            @endif
                        </div>
                    ...
                    <div class="flex items-center justify-between pt-1">
                        ...
                        @if (Route::has('register'))
                            <a class="text-xs font-black uppercase tracking-wider text-black dark:text-yellow-400 hover:underline" href="{{ route('register') }}">
                                Daftar Akun Baru
                            </a>
                        @endif
                    </div>
                    ...
                    <!-- Submit Button -->
                    <div class="pt-3">
                        <button type="submit" data-testid="btn-submit-login" class="w-full bg-yellow-400 hover:bg-yellow-300 text-black border-4 border-black dark:border-white font-black py-3.5 px-4 neo-btn-shadow neo-btn-interactive text-xs uppercase tracking-wider flex items-center justify-center gap-2 cursor-pointer">
