        ...
        <div class="col-span-12 lg:col-span-5 hidden lg:flex flex-col justify-between p-10 bg-black text-white relative overflow-hidden border-r-4 border-black dark:border-white">
            ...
            <div class="my-auto space-y-6 relative z-10">
                ...
                <p class="text-xs text-gray-300 leading-relaxed font-bold">
                    Masukkan kata sandi baru Anda untuk memulihkan akses ke akun Reservasi Anda.
                </p>
                
                <div class="space-y-4 pt-2">
                    <div class="flex items-center gap-3.5">
                        <span class="text-lg">🔒</span>
                        <span class="text-xs font-black uppercase tracking-wider text-yellow-400">Kata Sandi Baru yang Kuat</span>
                    </div>
                    <div class="flex items-center gap-3.5">
                        <span class="text-lg">🛡️</span>
                        <span class="text-xs font-black uppercase tracking-wider text-yellow-400">Proteksi Keamanan Berlapis</span>
                    </div>
                </div>
            </div>
        ...
        <div class="col-span-12 lg:col-span-7 p-8 sm:p-12 flex flex-col justify-center bg-white dark:bg-slate-900">
            <div class="w-full max-w-md mx-auto">
                ...
                <div class="mb-8 text-center lg:text-left">
                    <h2 class="text-3xl font-black text-black dark:text-white uppercase tracking-tight">Atur Ulang Sandi</h2>
                    <p class="text-xs text-gray-600 dark:text-gray-400 mt-1.5 font-bold uppercase tracking-wide">Masukkan email dan kata sandi baru Anda.</p>
                </div>
                ...
                <form method="POST" action="{{ route('password.store') }}" class="space-y-5" data-testid="form-reset-password">
                    @csrf
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input id="email" type="email" name="email" value="{{ old('email', request()->email) }}" required autofocus placeholder="name@example.com"
                                {{ request()->has('email') ? 'readonly' : '' }}
                                class="w-full border-4 border-black dark:border-white pl-10 pr-4 py-3.5 text-xs font-bold text-black dark:text-white outline-none transition duration-150 focus:ring-4 focus:ring-yellow-400 placeholder-gray-500 shadow-[4px_4px_0px_0px_#000000] dark:shadow-[4px_4px_0px_0px_#ffffff] {{ request()->has('email') ? 'bg-gray-100 dark:bg-slate-800 cursor-not-allowed' : 'bg-white dark:bg-slate-900 focus:bg-yellow-50 dark:focus:bg-slate-800' }}"
                    ...
                    <div class="pt-3">
                        <button type="submit" data-testid="btn-submit-reset-password" class="w-full bg-yellow-400 hover:bg-yellow-300 text-black border-4 border-black dark:border-white font-black py-3.5 px-4 neo-btn-shadow neo-btn-interactive text-xs uppercase tracking-wider flex items-center justify-center gap-2 cursor-pointer">
