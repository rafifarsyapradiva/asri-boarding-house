<x-guest-layout size="lg">
    @section('title', 'Lupa Kata Sandi Portal Administrator')
        ...
        <div class="col-span-12 lg:col-span-5 hidden lg:flex flex-col justify-between p-10 bg-black text-white relative overflow-hidden border-r-4 border-black dark:border-white">
            ...
            <div class="my-auto space-y-6 relative z-10">
                ...
                <p class="text-xs text-gray-300 leading-relaxed font-bold">
                    Masukkan alamat email administrator Anda yang terdaftar. Kami akan mengirimkan email berisi tautan token untuk mengatur ulang kata sandi Anda.
                </p>
        ...
        <div class="col-span-12 lg:col-span-7 p-8 sm:p-12 flex flex-col justify-center bg-white dark:bg-slate-900">
            <div class="w-full max-w-md mx-auto">
                ...
                <div class="mb-8 text-center lg:text-left">
                    <h2 class="text-3xl font-black text-black dark:text-white uppercase tracking-tight">Lupa Kata Sandi Admin</h2>
                    <p class="text-xs text-gray-600 dark:text-gray-400 mt-1.5 font-bold uppercase tracking-wide">Masukkan email administrator terdaftar untuk mendapatkan tautan reset.</p>
                </div>
                ...
                <form method="POST" action="{{ route('admin.password.email') }}" class="space-y-5" id="forgotForm" data-testid="form-admin-forgot-password">
                    @csrf
                    ...
                    <div class="text-center pt-2">
                        <a href="{{ route('admin.login') }}" class="text-xs font-black uppercase tracking-wider text-black dark:text-yellow-400 hover:underline">
