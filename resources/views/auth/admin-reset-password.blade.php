<x-guest-layout size="lg">
    @section('title', 'Atur Ulang Kata Sandi Portal Administrator')
        ...
        <div class="col-span-12 lg:col-span-5 hidden lg:flex flex-col justify-between p-10 bg-black text-white relative overflow-hidden border-r-4 border-black dark:border-white">
            ...
            <div class="my-auto space-y-6 relative z-10">
                ...
                <p class="text-xs text-gray-300 leading-relaxed font-bold">
                    Silakan masukkan kata sandi baru Anda yang kuat dan aman. Setelah berhasil diatur ulang, Anda dapat langsung masuk kembali ke portal administrator.
                </p>
                ...
                <div class="space-y-4 pt-2">
                    ...
                    <div class="flex items-center gap-3.5">
                        <span class="text-lg">🔑</span>
                        <span class="text-xs font-black uppercase tracking-wider text-yellow-400">Langsung Masuk Portal Administrator</span>
                    </div>
                </div>
            </div>
        ...
        <div class="col-span-12 lg:col-span-7 p-8 sm:p-12 flex flex-col justify-center bg-white dark:bg-slate-900">
            <div class="w-full max-w-md mx-auto">
                ...
                <div class="mb-8 text-center lg:text-left">
                    <h2 class="text-3xl font-black text-black dark:text-white uppercase tracking-tight">Atur Ulang Kata Sandi Admin</h2>
                    <p class="text-xs text-gray-600 dark:text-gray-400 mt-1.5 font-bold uppercase tracking-wide">Buat kata sandi baru untuk mengamankan akun administrator Anda.</p>
                </div>
                ...
                <form method="POST" action="{{ route('admin.password.update') }}" class="space-y-4" id="resetForm" data-testid="form-admin-reset-password">
                    @csrf
