...
if "Revisi v209.0" in content:
    print("Revisi v209.0 is already present in Blueprint.")
else:
    new_content = content.rstrip() + revision_text + "\n"
    with open(blueprint_path, "w", encoding="utf-8") as f:
        f.write(new_content)
    print("Successfully appended Revisi v209.0 to Blueprint_Projek_Web_Asri_Boarding_House.md")
